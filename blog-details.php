...
$url = $_GET['blog_url'];
$sqli = "SELECT * FROM blogs where `blog_url` = '$url'";
    ...
    <section class="half-section pb-0">
        <div class="container">
            <div class="row justify-content-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                <div class="mb-6">
                    <img alt="" class="border-radius-5px" data-cfsrc="Uploads/blogs/<?php echo $row1['image'] ?>">
                    <img src="Uploads/blogs/<?php echo $row1['image'] ?>" alt="" class="border-radius-5px">
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-1">
                <div class="col-lg-7 text-center">
                    <span class="bg-white box-shadow-quadruple-large text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "delay": 500, "staggervalue": 100, "easing": "easeOutQuad" }'>Blogs</span>
                    <h3 class="alt-font text-dark-gray fw-600 ls-minus-1px" data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "delay": 500, "staggervalue": 100, "easing": "easeOutQuad" }'> Other Blogs</h3>
                </div>
            </div>
            <div class="row">
                            ...
                            <li class="grid-item">
                                <div class="card bg-transparent border-0 h-100">
                                    <div class="blog-image position-relative overflow-hidden border-radius-4px">
                                        <a href="blog-details.php?blog_url=<?php echo $row['blog_url'] ?>"><img alt="" data-cfsrc="Uploads/blogs/<?php echo $row['image'] ?>" style="display:none;visibility:hidden;" /><img src="Uploads/blogs/<?php echo $row['image'] ?>" alt="" /></a>
                                    </div>
                                    <div class="card-body px-0 pb-30px pt-30px xs-pb-15px last-paragraph-no-margin">
                                        <span class="fs-13 text-uppercase mb-5px d-block">
                                            <a href="blog-details.php?blog_url=<?php echo $row['blog_url'] ?>" class="text-dark-gray fw-500 categories-text">Blog</a>
                                            <!-- <a href="#" class="blog-date">26 August 2023</a> -->
                                        </span>
                                        <a href="blog-details.php?blog_url=<?php echo $row['blog_url'] ?>" class="card-title mb-0 fw-500 fs-18 lh-30 text-dark-gray d-inline-block"><?php echo $row['title'] ?></a>
                                    </div>
                                </div>
                            </li>
                            <!-- end blog item -->
