...
<!-- Mirrored from craftohtml.themezaa.com/demo-business-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Sep 2024 09:29:46 GMT -->
...
<body data-mobile-nav-style="classic">
    ...
    <!-- end header -->
    <!-- start page title -->
    <section class="page-title-big-typography bg-dark-gray ipad-top-space-margin" data-parallax-background-ratio="0.5" style="background-image: url(image/contact.png)">
        <div class="opacity-extra-medium bg-dark-slate-blue"></div>
        <div class="container">
            <div class="row align-items-center justify-content-center extra-small-screen">
                <div class="col-12 position-relative text-center page-title-extra-large">
                    <h1 class="m-auto text-white text-shadow-double-large fw-500 ls-minus-3px xs-ls-minus-2px" data-anime='{ "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>Make an Appointment</h1>
                </div>
            ...
            <div class="row g-0 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6" data-anime='{ "translateX": [15, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="bg-base-color p-18 lg-p-15 h-100">
                        ...
                        <p class="text-white opacity-5">1656B/15, Govind Puri, Kalkaji, New Delhi-110019</p>
                        <span class="text-white text-decoration-line-bottom mb-10px d-inline-block">Toll-free customer care?</span>
                        <p>
                            <a href="tel:9310918718" class="text-white opacity-5">93109 18718</a><br>
                            <a href="tel:9821923667" class="text-white opacity-5">98219 23667</a><br>
                            <a href="tel: 011-41045629" class="text-white opacity-5"> 011-41045629</a>
                        </p>
                        <span class="text-white text-decoration-line-bottom mb-10px d-inline-block">Need live support?</span>
                        <a href="mailto:alpha.dml2022@gmail.com" class="text-white opacity-5 d-block">alpha.dml2022@gmail.com</a>
                    </div>
                </div>
                <div class="col-lg-4 offset-lg-1">
                    <div class="pt-5 md-pt-45px contact-form-style-01" data-anime='{ "translateX": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h4 class="d-inline-block alt-font fw-600 text-dark-gray ls-minus-1px mb-30px">Feel free to reach out via the contact form.</h4>
                        <!-- start contact form -->
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 p-0">
                    <div id="map" class="map" data-map-options='{ "lat": -37.805688, "lng": 144.962312, "style": "Silver", "marker": { "type": "HTML", "color": "#5758D6" }, "popup": { "defaultOpen": false, "html": "<div class=infowindow><strong class=\"mb-3 d-inline-block alt-font\">Crafto Business</strong><p class=\"alt-font\">16122 Collins street, Melbourne, Australia</p></div><div class=\"google-maps-link alt-font\"> <a aria-label=\"View larger map\" target=\"_blank\" jstcache=\"31\" href=_https_/maps.google.com/mapse283.html?ll=-37.805688,144.962312&amp;z=17&amp;t=m&amp;hl=en-US&amp;gl=IN&amp;mapclient=embed&amp;cid=13153204942596594449\%22 jsaction=\"mouseup:placeCard.largerMap\">VIEW LARGER MAP</a></div>" } }'></div>
                </div>
            </div>
        </div>
    </section>
